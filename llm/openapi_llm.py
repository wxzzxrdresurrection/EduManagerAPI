...
def clean_text(text: str) -> str:
    ...
    # Fix spaces within words caused by chunking
    text = re.sub(r'(\w)\s+([áéíóúÁÉÍÓÚñÑ])', r'\1\2', text)  # Handle accented letters
    text = re.sub(r'([áéíóúÁÉÍÓÚñÑ])\s+(\w)', r'\1\2', text)  # Handle continuation after accented letters
